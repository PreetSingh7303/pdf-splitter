...
console.log(selectedPages,'selectedpages');
  const handleUpload = async () => {
    ...
    try {
      const res = await axios.post('https://pdf-splitter2.onrender.com/upload', formData, {
        headers: {
  ...
  const handleCreatePDF = async () => {
    ...
    try {
      ...
      const res = await axios.post('https://pdf-splitter2.onrender.com/create-pdf', formData, {
        responseType: 'blob',
      });
